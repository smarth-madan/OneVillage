	...
	public String createAlbum(Album album) {
		...
		try {
			...
			if (album.getUserid() != null){
				...
				dbObject.append("createdDate",album.getCreatedDate());
		...
		try {
			...
			if (album.getUserid() != null){
				...
				if(cursor.hasNext()){
					...
					createdDate = (String)dbObject.get("createdDate");
				}
				...
				modifyObject.append("createdDate",createdDate);
	...
	public ArrayList<Album> getAllAlbums() {
		...
		try {
			...
			while(cursor.hasNext()){
				...
				album.setCreatedDate((String)dbObject.get("createdDate"));
				albumList.add(album);
			}
		} catch (Exception e) {
			// TODO Auto-generated catch block
